...
class Configuration(object):
    ...
    KNOWN_DATA_PATHS = {'local':  "D:/UBC - Postdoc/Sensors/Motion Reconstruction/MPI SMPL DIP/DIP_IMU_data",  # TODO enter path to data here
                        'server': "D:/UBC - Postdoc/Sensors/Motion Reconstruction/MPI SMPL DIP/DIP_IMU_data"}  # TODO enter path to data here
    ...
    def set_data_dir(self):
        ...
        self.config['test_ubc_data'] = os.path.join(self.data_dir, "imu_ubc_data.npz")
    ...
    def define_evaluation_setup(parser):
        ...
        parser.add_argument('--datasets', nargs='+', choices=['dip-imu', 'tc', 'playground', 'ubc'],
